...
module.exports = [
    ...
    check('descripcion').isLength({min: 5, max: 100}).withMessage("Debe contener de 5 a 100 caracteres"),
    ...
    check('desc2').isLength({min: 20, max: 1500}).withMessage("Debe contener de 20 a 1500 caracteres"),    
