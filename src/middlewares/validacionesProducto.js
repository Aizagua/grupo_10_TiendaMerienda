...
module.exports = [
    ...
    check('descripcion').isLength({min: 10, max: 300}).withMessage("Debe contener de 10 a 300 caracteres"),
    ...
    check('desc2').isLength({min: 20, max: 500}).withMessage("Debe contener de 20 a 300 caracteres"),    
