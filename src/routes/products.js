...
//Editar Producto
router.get('/products/edit/:id', adminBlockeadeMiddleware, adminBlockeadeMiddleware,products.edit)
...
router.get ("/productList",adminBlockeadeMiddleware, products.list);
